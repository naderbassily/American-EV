	...
	<div class="container">
		<div class="footer-grid">
			...
			<div class="footer-nav">
				...
				<div><h3><?php esc_html_e( 'Company', 'american-ev' ); ?></h3><ul><li><a href="<?php $aev_about = get_page_by_path( 'about' ); echo esc_url( $aev_about ? get_permalink( $aev_about ) : aev_home_anchor( 'process' ) ); ?>">About</a></li><li><a href="<?php echo esc_url( aev_home_anchor( 'contact' ) ); ?>">Contact</a></li><li><a href="<?php echo esc_url( aev_home_anchor( 'contact' ) ); ?>">Request a quote</a></li></ul></div>
